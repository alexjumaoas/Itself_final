...
<head>
    ...
    <title>IT Services Logistics Framework</title>
        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">ITSELF</span>
                </a>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">IT Services <br>Logistics Framework.</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">The DOH 7 Technical Assistance Requisition System is a web-based platform developed to facilitate the management and resolution of IT-related assistance requests for the Department of Health Region VII. This system is designed to streamline the submission, tracking, and resolution of technical issues, ensuring prompt and efficient support for the agency's IT needs.</p>
            </div>
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{asset('images/itselflogo.png') }}" alt="hero image">
            </div>                
        </div>
    </section>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">IT Services Logistics Framework</h2>
    ...
    <footer class="bg-white dark:bg-gray-800">
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024-2025 ITSELF™. All Rights Reserved. Built with <a href="" class="text-purple-600 hover:underline dark:text-purple-500">Flowbite</a> and <a href=" " class="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a>.
                </span>
