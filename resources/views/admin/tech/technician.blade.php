              ...
              <div
                ...
                <div class="w-full md:w-1/2 max-w-medium bg-white dark:bg-gray-800 rounded-lg p-6">
                  <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Employee Details</h3>
                    ...
                    <form method="POST" action="{{ route('technicians.add') }}">
                        @csrf <!-- CSRF protection for Laravel -->              
                          <div class="mb-4">
                            ...
                            <input type="hidden" name="usertype" x-model="3">
                        ...
                        <div class="mt-4">
                          <button type="submit"  @click="TechnicianModal"  class="w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                            Add as Technician
                          </button>
                        </div>
                    </form>
